  ...
  const posts = [
    {
      ...
      excerpt:
        "Exploring the future of sustainable agriculture and eco-friendly farming practices.",
      date: "Nov 15, 2024",
    },
    {
      image: irrigationImg,
      ...
      excerpt:
        "Effective organic methods to protect your crops without harmful chemicals.",
      date: "Nov 10, 2024",
    },
    {
      image: greenhouseImg,
      ...
      excerpt:
        "Real farmers share their journey to sustainable organic farming.",
      date: "Nov 5, 2024",
    },
  ];
      ...
      <div className="container mx-auto px-4">
        <div className="text-center max-w-2xl mx-auto mb-12">
          ...
          <p className="text-muted-foreground">
            Stay updated with the latest trends, tips, and success stories in
