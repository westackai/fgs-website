...
const Navbar = () => {
  ...
  return (
    <nav className="fixed top-0 left-0 right-0 z-50 bg-white backdrop-blur-sm shadow-md">
      <div className="container mx-auto px-4">
        <div className="flex items-center justify-between h-16">
          ...
          <div className="hidden md:flex items-center gap-4">
            <Button className="bg-primary hover:bg-primary/90" onClick={() => router.push("/contact")}>
              Get Started
            </Button>
          </div>
