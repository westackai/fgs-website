        ...
        <div className="container mx-auto px-4 relative z-10 text-center text-white">
          ...
          >
            <motion.div
              ...
              className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-white/10 backdrop-blur-sm border border-white/20 text-sm font-medium mb-6"
            >
            ...
            >
              Advanced technology and massive capacity to meet global demand
            ...
            <div className="grid lg:grid-cols-2 gap-16 items-center">
              <div>
                ...
                <p className="text-muted-foreground text-lg mb-8">
                  Our facility is equipped with extensive storage capabilities
                  to ensure consistent supply and grain preservation throughout
                  the year.
                </p>
            ...
            <div className="grid lg:grid-cols-2 gap-16 items-center">
              ...
              <div className="order-1 lg:order-2">
                ...
                <h2 className="text-4xl font-bold mb-6">
                  UHD Sortex Technology
                </h2>
                <p className="text-white/70 text-lg mb-8 leading-relaxed">
                  We utilize state-of-the-art **Meyer Sortex** machines
                  featuring UHD AI Technology with Wormhole Detection. This
                  ensures every grain meets the highest standards of purity and
                  color consistency.
                </p>
