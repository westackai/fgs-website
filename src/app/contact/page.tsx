      ...
      <section className="relative h-[40vh] min-h-[400px] flex items-center justify-center overflow-hidden">
        ...
        <div className="container mx-auto px-4 relative z-10 text-center text-white pt-20">
          ...
          <p className="text-xl text-white/90 max-w-2xl mx-auto leading-relaxed">
            Leading the way in quality grain processing and sustainable farming
            since 1984.
          </p>
        </div>
      </section>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center mb-20">
            <div>
              ...
              <p className="text-muted-foreground mb-6 leading-relaxed text-lg">
                ...
                been consistently manufacturing and supplying quality products
                in India and abroad.
              </p>
              <p className="text-muted-foreground mb-8 leading-relaxed text-lg">
                From a humble beginning with a hand mill, the company has come a
                long way in more than four decades of journey. In 2024, the
          ...
          <div className="flex flex-col md:flex-row items-center justify-between gap-12">
            <div className="md:w-1/2">
              ...
              <p className="text-muted-foreground text-lg mb-8">
                We proudly export to over 20 countries, bridging the gap between
                Indian farms and global dining tables. Our logistics network
                ensures timely and safe delivery, anywhere.
              </p>
