  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <section className="relative py-20 pt-40 bg-forest text-cream overflow-hidden">
        <div className="absolute inset-0 bg-[url('https://images.unsplash.com/photo-1586201375761-83865001e31c?q=80&w=2940&auto=format&fit=crop')] bg-cover bg-center opacity-10" />
        <div className="container mx-auto px-4 relative z-10 text-center">
          <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-cream/10 text-cream backdrop-blur-sm border border-cream/20 text-sm font-medium mb-6 animate-fade-in">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-start mb-16">
            <div className="space-y-6">
              ...
              <p className="text-muted-foreground text-lg leading-relaxed">
                ...
                (Cajanus cajan), is a staple split legume widely used in Indian
                cuisine. It is valued for its versatility in dishes like dal
                tadka, sambar, and khichdi, offering a nutty flavor and quick
                cooking time.
              </p>
              ...
              <div className="grid sm:grid-cols-2 gap-6 bg-cream/50 p-6 rounded-2xl border border-cream/20">
                ...
                <ul className="space-y-3 col-span-full sm:col-span-1">
                  ...
                  <li className="flex items-start gap-2 text-sm text-foreground/80">
                    <span className="h-1.5 w-1.5 rounded-full bg-primary mt-2 shrink-0"></span>
                    <span>
                      <strong>Fiber High:</strong> Promotes digestion and heart
                      health.
                    </span>
                  </li>
                </ul>
          ...
          <div className="grid md:grid-cols-3 gap-6 mb-16">
            ...
            <div className="bg-white p-6 rounded-2xl shadow-sm border border-border">
              ...
              <div className="text-sm space-y-1 mt-2">
                ...
                <div className="flex justify-between">
                  <span>🇮🇳 India</span> <span className="font-medium">11%</span>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center mb-16">
            ...
            <div className="order-1 lg:order-2 space-y-6">
              ...
              <p className="text-muted-foreground text-lg leading-relaxed">
                ...
                larger, creamier variety distinguished by its smooth coat. With
                a nutty, earthy flavor, it is ideal for dishes like chole
              ...
              <div className="grid grid-cols-2 gap-4">
                <div className="p-4 bg-white rounded-xl border border-border">
                  ...
                  <div className="font-semibold text-forest">Heart Healthy</div>
            ...
            <div className="relative z-10">
              ...
              <div className="grid md:grid-cols-4 gap-8">
                ...
                <div>
                  ...
                  <div className="font-medium text-lg mb-1">India's Share</div>
                  <div className="text-sm text-cream/60">
